 ...
 * @author Nurpujiyatun
 */
public class Asisten implements Seleksi {
  private String nama,nim;
  private int ratarata;
  private int nilai1,nilai2,nilai3,nilai4;
  private String lihatAkhir;
    
    public Asisten(String nama,String nim,int nilai1,int nilai2,int nilai3,int nilai4){
        this.nama = nama;
        this.nim  = nim;
        this.nilai1 = nilai1;
        this.nilai2 = nilai2;
    ...
    public String lihatAkhir(){
        if (getRataRata()>85 && getRataRata()<101){
            ...
            System.out.println("Yeah! "+nim+" SELAMAT ANDA DITERIMA SEBAGAI ASiSTEN LABORATORIUM");
        }else {
